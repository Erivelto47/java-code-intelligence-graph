...
| `03-unresolved-decision-shapes` | `com.example.decisiontrace.unresolved.RegistrationGuard.validate` | Phase 4.2.2 recognized unsupported Java decision shapes emitted as unresolved records. |
...
| `08-method-local-decision-call` | `com.example.decisiontrace.localcall.UserRegistration.create` | Phase 4.4 one-level same-class helper call extraction with helper source evidence. |

## Future Fixtures

Planned examples:

- `09-unsupported-optional-chain`
